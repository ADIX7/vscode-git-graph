...
describe('Logger', () => {
	...
	it('Should log message to the Output Channel', () => {
		...
		// Assert
		expect(vscode.OutputChannel.appendLine).toHaveBeenCalledWith('[2020-04-22 22:40:58.000] Test');
	...
	it('Should log command to the Output Channel', () => {
		...
		// Assert
		expect(vscode.OutputChannel.appendLine).toHaveBeenCalledWith('[2020-04-22 22:40:58.100] > git --arg1 --arg2 --format=... --arg3 "arg with spaces"');
	...
	it('Should log error to the Output Channel', () => {
		...
		// Assert
		expect(vscode.OutputChannel.appendLine).toHaveBeenCalledWith('[2020-04-22 22:40:58.010] ERROR: Test');
